...
export default function Home() {
  ...
  return <>
    ...
    <Header />
    <main id="accueil">
      <section className="hero" aria-labelledby="hero-title"><div className="hero-photo" aria-hidden="true"><video autoPlay muted playsInline loop preload="metadata" poster="/hero-poster.webp" className="hero-video" aria-hidden="true"><source src="/hero-desktop.mp4" media="(min-width: 768px)" type="video/mp4" /><source src="/hero-mobile.mp4" type="video/mp4" /></video></div><div className="hero-shade" /><div className="hero-grain" aria-hidden="true" /><div className="container hero-inner"><div className="hero-content"><p className="hero-eyebrow"><span className="red-line" /> EVENT & AUDIOVISUAL PRODUCTION</p><h1 id="hero-title"><span className="hero-line"><span>VOTRE ÉVÉNEMENT.</span></span><span className="hero-line"><span><em>NOTRE EXPERTISE</em></span></span><span className="hero-line"><span>TECHNIQUE.</span></span></h1><p>Production événementielle et audiovisuelle au Maroc. De la préparation à la réalisation, une équipe et un parc matériel au service de vos projets.</p><a className="button button-red" href="#expertises">Découvrir nos expertises <Arrow /></a></div></div><a className="hero-scroll" href="#apropos" aria-label="Aller à la section À propos"><span /></a></section>
