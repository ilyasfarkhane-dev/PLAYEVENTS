...
export default function Home() {
  ...
  return <>
    ...
    <main id="accueil">
      ...
      <div className="infinite-ribbon" role="img" aria-label="Production, captation, expérience et immersion"><div className="ribbon-track" aria-hidden="true">{[0,1].map(i=><div className="ribbon-copy" key={i}><span>PRODUCTION</span><b>✦</b><span>CAPTATION</span><b>✦</b><span>EXPÉRIENCE</span><b>✦</b><span>IMMERSION</span><b>✦</b></div>)}</div></div>
    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-bottom">
          ...
          <a className="footer-top-link" href="#accueil">Retour en haut ↑</a>
        </div>
      </div>
    </footer>
  </>;
